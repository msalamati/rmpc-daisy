...
The implementation of EMPC stores a lookup table of the affine maps and performs a number of affine computations
...
First, implementations of EMPCs can suffer from large memory usage, because the solution of the optimization
...
which considers finite-precision implementation errors as disturbances
