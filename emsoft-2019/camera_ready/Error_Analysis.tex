...
$p$ and can also be called explicitly without the precision optimization. \Mahmoudd{To encourage reproducible research, our implementation is made available. \footnote{Please insert the link to our package here!!!}}
