...
We use MATLAB to find a robust explicit MPC with disturbance set $\mathcal W_{\Delta_0}$. Over the computed controller, we compute the error due to incorrect region selection $e$ and in case that $e<\Delta$, we ask Daisy
...
\Sadegh{
Unfortunately, $\Delta_0=0$ is not realizable, as the point location error is $0.019$ and hence $e>\Delta_0$. 
