...
word length for each value, several tools~\cite{Daisy,Gappa} automatically determine the number of
...
affine arithmetic~\cite{affineArithmetic} which compute sound enclosures. Since intervals do not
...
simulated annealing~\cite{}. \eva{add missing refs}
