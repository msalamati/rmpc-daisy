...
word length for each value, several tools\Mahmoud{, including the tool Daisy which we use,} automatically determine the number of
...
Automated mixed-precision tuning tools\Mahmoud{, including Daisy,} usually perform a search: they repeatedly
