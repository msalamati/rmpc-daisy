...
We use Matlab's MPT toolbox~\cite{matlabMPT} to compute the explicit MPC, while underlying computations rely on YALMIP(\cite{matlabYALMIP}). For the inverted pendulum MPT toolbox~\cite{matlabMPT} computes a controller
