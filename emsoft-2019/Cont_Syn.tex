...
G, H, K} and the error bounds in Daisy's input format. The precision tuning for activation functions (line 12) and hyperplanes (line 13) can be efficiently done in parallel, because the analysis of a single region is completely independent from the others. Same holds for hyperplanes. 
